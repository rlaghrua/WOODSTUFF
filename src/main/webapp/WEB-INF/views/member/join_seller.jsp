                ...
                <form id="mem_frm" name="mem_frm" action="join_seller.do" method="post" accept-charset="utf-8">
                    ...
                    <!-- http://k.kakaocdn.net/dn/dpk9l1/btqmGhA2lKL/Oz0wDuJn1YV2DIn92f6DVK/img_110x110.jpg -->
                     ...
                     <%-- <div class="form-group">
                        <label for="exampleInputPassword1">프로필</label>
                         ...
                         <c:if test="${kakaoVo == null}">
                        	<img src="../resources/image/KakaoTalk_20220418_121005755.png" class="rounded float-left profile" alt="...">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            ...
                            > 
                            &nbsp;<input type="button" class="btn btn-dark" value="중복 확인" onclick="checkID()" style="width: 30%; padding:10px 10px; text-align: center;">
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                     <label for="exampleFormControlInput1">주소</label>
						...
						<input class="form-control" style="margin-bottom: 10px; "placeholder="우편번호" name="member_postnum" id="addr1" type="text" readonly="readonly" >
						    <button type="button" class="btn btn-dark" style="padding: 10px 10px;" onclick="execPostCode();"><i class="fa fa-search"></i>주소 찾기</button>                               
						</div>
						<div class="form-group">
                    ...
                    <div class="form-group form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">WOODSTUFF 이용 약관 동의</label>
                    ...
                    <br>
                     ...
                     <button  type="button"  onclick="checkAll()" class="btn btn-dark" id="join_bnt" style="width: 100%;">회원가입</button><br>
                </form>
            </div>
        </div>
    </div>
