...
<body>
    ...
    <div class="container" style="margin-top: 6%; margin-bottom: 6%;">
        ...
        <!-- 아이디 찾기  -->
            <div class="col-md-6">
                <div style="font-weight: 600; color: black; padding-bottom: 5px; margin-bottom: 15px; border-bottom: 2px solid black;">이메일 찾기</div>
                ...
                <div style="text-align: center; margin-top: -10px;">
                    <button type="button" class="btn btn-dark" style=" border: none;" id="findId">이메일 찾기</button>
                </div>
            </div>
            
        <!-- 비밀번호 찾기  -->
            <div class="col-md-6">
                <div style="font-weight: 600; color: black; padding-bottom: 5px; margin-bottom: 15px; border-bottom: 2px solid black;">비밀번호 찾기</div>
                <table style="margin: 20px; border-collapse: separate; border-spacing: 0 10px;">
                    <tr>
                        <th>이메일</th>
                ...
                <div style="text-align: center; margin-bottom: 15px;">
                    <button type="button" class="btn btn-dark" style=" border: none;" id="findPw">비밀번호 찾기</button>
                </div>
            </div>
        </div>
