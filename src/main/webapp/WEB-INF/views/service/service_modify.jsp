...
<body>
    ...
    <input type="hidden" name="sboard_idx" value="${vo.sboard_idx}">
        ...
        <div class="container">
            수정하시겠습니까?
            <input type="submit" class="btn btn-dark" style="padding: 10px 10px;" value="네">
    ...
    <div class="float-md-right">
			<button class="btn btn-dark" id="popup_open_btn" style="margin-top: 20px; padding:10px 10px;">수정하기</button>
		</div>
    </div>
    </section>
