...
<body>
  ...
  <ul class="icons3">
    ...
    <li>
      ...
      <div class="contents1_bold">와디즈 스토어는 크라우드 펀딩을 성공적으로 마친 제품의 판로 개척을 위해 제공되는 서비스에요.<br>
    ...
    <li>
      ...
      <div class="contents2">
        이에 따라 개발 중인 제품은 와디즈 스토어를 통해 상품을 공급할 수 없어요. 최종 양산된 제품만을 등록할 수 있습니다.<br>
        와디즈는 스토어 서비스 이용자의 보호를 위해 '전자상거래 등에서의 소비자보호에 관한 법률'에 의거하여 소비자의 청약철회 등의 권리 행사를 보장합니다.
